...
public class CharacterDetailActivity extends RoboActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCharacter = (Character) intent.getExtras().getSerializable("character");
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch(position) {
                case 0:
                    return CharacterDetailFragment.newInstance(mCharacter);
            }
